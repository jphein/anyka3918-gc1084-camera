...
echo
echo "Reminders:"
echo "  * gergehack.sh + gergesettings.txt are copied into the camera's flash on"
echo "    FIRST boot only. A camera that already has them keeps its old copies -"
echo "    edit /etc/jffs2/gergesettings.txt over telnet to change them later."
